...
- Dodano `data/media-v46.json`.
- Dodano strukturę `assets/images/*`.
- Dodano panel Media Studio PRO w `admin/`.
- Dodano podglądy kadrów i bibliotekę demo mediów.
- Przygotowano Theme Media dla motywów sezonowych i elektronicznych.

## v4.6.5 — Layout Builder

- Dodano `data/layout-v465.json`.
- Dodano `assets/css/v465-layout-builder.css`.
- Dodano `assets/js/v465-layout-builder.js`.
- Dodano zakładkę Layout Builder w ELKASS Studio.
