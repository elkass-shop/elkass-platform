...
function applyTheme(){ const t=readTheme(); document.body.className=document.body.className.replace(/ theme-[a-z0-9]+/g,''); document.body.classList.add('theme-'+(t.theme||'premium')); if(t.message){ document.documentElement.style.setProperty('--theme-message','"'+t.message.replace(/"/g,'')+'"'); }}
